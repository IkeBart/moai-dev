...
protected:
	...
	virtual void		GetDelta			( MOAIAttrOp& attrOp, const MOAIAnimKeySpan& span0, const MOAIAnimKeySpan& span1 )  = 0; // removed const declaration
	MOAIAnimKeySpan		GetSpan				( float time ) const;
	virtual void		GetValue			( MOAIAttrOp& attrOp, const MOAIAnimKeySpan& span ) = 0; // removed const declaration
...
public:
	...
	void				Clear					();
	virtual void		Draw					( u32 resolution ) ;  // removed const declaration
